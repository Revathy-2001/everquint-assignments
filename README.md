...
| 3 | Max Profit (building schedule) | [`max-profit/`](./max-profit/) | Open `max-profit/index.html` in a browser |
...
- SVG visualization: yellow = terrain, blue = water.
...
Assignments 2 and 3 use **vanilla HTML, CSS, and JavaScript** (no build step).
